export const CHORDS = [
  ...
  // { name: "C#m6/E",    notes: ["E1", "G#1", "A#1"] },
  // { name: "C#m6/G#",   notes: ["G#1", "A#1", "E2"] },
  // { name: "C#m6/A#",   notes: ["A#1", "E2", "G#2"] },
  // { name: "Dm6/F",     notes: ["F1", "A1", "B1"] },
  // { name: "Dm6/A",     notes: ["A1", "B1", "F1"] },
  // { name: "Dm6/B",     notes: ["B1", "F1", "A1"] },
